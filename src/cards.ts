...
export const CARDS: Card[] = [
    ...
    { id: '4-ribbon', month: 4, type: 'ribbon', name: 'Wisteria Grass Ribbon', img: images.april_tanzaku },
    ...
    { id: '5-ribbon', month: 5, type: 'ribbon', name: 'Iris Grass Ribbon', img: images.may_tanzaku },
    ...
    { id: '6-ribbon', month: 6, type: 'ribbon', name: 'Peony Blue Ribbon', img: images.june_tanzaku },
    ...
    { id: '7-ribbon', month: 7, type: 'ribbon', name: 'Clover Grass Ribbon', img: images.july_tanzaku },
    ...
    { id: '9-ribbon', month: 9, type: 'ribbon', name: 'Chrysanthemum Blue Ribbon', img: images.september_tanzaku },
    ...
    { id: '10-ribbon', month: 10, type: 'ribbon', name: 'Maple Blue Ribbon', img: images.october_tanzaku },
    ...
    { id: '11-ribbon', month: 11, type: 'ribbon', name: 'Willow Ribbon', img: images.november_tanzaku },
